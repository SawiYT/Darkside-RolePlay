		...
		<div id='home' className='relative h-screen w-full'>
			...
			<div className='relative z-30 h-full flex font-raleway items-center'>
				<div className='w-full max-w-7xl mx-auto px-6 sm:px-12'>
					<h1 className='text-white max-w-[40rem] font-black uppercase text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-snug'>
						A server where you can be whoever you want
					</h1>
					<p className='max-w-xl text-white opacity-75 sm:opacity-80 p-2 text-lg sm:text-xl md:text-2xl'>
						Darkside RP is one of the best GTA V roleplay servers. Join thousands of passionate players and create your
						own story. Show the world who you truly are.
					</p>
					<button className='max-w-xl text-white m-2 px-10 py-2 bg-[#F92763] rounded-lg'>
						<p className='font-bold uppercase'>check it out</p>
					</button>
				</div>
			</div>
		</div>
