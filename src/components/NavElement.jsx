const NavElement = ({ content, active, scrollToId, closeMenu }) => {
	...
	return (
		<button
			onClick={handleClick}
			className={`relative flex font-semibold uppercase flex-row items-center transition-transform transform hover:shadow-lg hover:opacity-100 hover-underline mx-3 text-white opacity-100 md:opacity-40
